      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div v-for="article in articles" :key="article.slug" class="px-4 order rounded shadow">
          ...
          <p class="text-sm text-gray-500 mb-2 flex items-center">
            ...
            <button @click="handleEditSlug(article)" class="ml-2 w-5 h-5 flex items-center justify-center">
              <svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-5 h-5">
